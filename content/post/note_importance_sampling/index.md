...
\begin{equation}
\begin{aligned}
\boldsymbol{y}\_t &= \mathbf{Z} \boldsymbol{\alpha}\_t + \boldsymbol{\varepsilon}\_t, \\qquad  \boldsymbol{\varepsilon}\_t \sim NID \left( \mathbf{0}, \mathbf{H} \right) \\\\\\
